...
Tables 2-4 describe the different specifiers for the different experiments as described in Table 1. They are used in the file names of the corresponding input files and should also be used for the names of the output files (see [report model results](#5-reporting-model-results)).
