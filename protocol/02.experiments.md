...
::: show simulation_round=ISIMIP3b
    ...
    Table 2.5 lists the priorities for the different **group III** experiments in ISIMIP3b in 8 tiers. We kindly ask you to run the experiments marked as **Tier 1: Core set** in any case and the other experiments with the priority given as a number.
