...
::: show simulation_round=ISIMIP3b sector=water_global
    ...
    For the ISIMIP3b Group III simulations, modelling teams in the global water sector are requested to first use the land use and irrigation direct human forcings, as well as non-irrigation water use for the models that need it, for the adaptation and no adaptation runs.
