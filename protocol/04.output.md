...
::: show sector=labour
    ...
    ::: table identifier=exp caption="Table 4.10: Exposure identifiers (`exp`)."
...
::: hide simulation_round=ISIMIP3b

    No additional notes are available for this selection of simulation round and sectors.
