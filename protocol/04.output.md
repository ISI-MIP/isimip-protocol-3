...
::: table number=4.1 identifier=variable
...
::: show sector=agriculture
    ...
    ::: table number=4.2 identifier=crop

    #### Irrigation

    ::: table number=4.3 identifier=irrigation

    #### Harmonization

    ::: table number=4.4 identifier=harmonization

::: show sector=forestry

    #### Species

    ::: table number=4.5 identifier=species

    #### Forest stands

    ::: table number=4.6 identifier=forest_stand

::: show sector=lakes_local

    #### Lake sites

    ::: table number=4.7 identifier=lake_site
...
::: show sector=marine-fishery_local
    ...
    ::: table number=4.8 identifier=ocean_region

::: show sector=water_regional

    #### Catchment gauging stations

    ::: table number=4.9 identifier=river_basin
...
::: show sector=peat
    ...
    ::: table number=4.10 identifier=peat_soil

    All variables should be reported separately for the peat fraction of the grid cell if they are calculated separately for peat and non-peat grid-cell fractions, with the extension `-<peatsoil>` taking the fixed values `<peatsoil> = peat, drainpeat, restorepeat, minl` to the variable name to describe the peat soil type. Otherwise the extension is ommited the and the variable specifiers follow the conventions from the other sectors.
...
::: hide sector=agriculture,biomes,fire,peat,permafrost,health
