...
::: show simulation_round=ISIMIP4b
    ...
    **ISIMIP4b** is dedicated to a **quantification of climate-related risks** at different levels of climate change and direct human forcing. The **Group I** simulations refer to the pre-industrial and historical period of the CMIP6-based climate simulations. **Group II** covers all future projections assuming fixed 2021 levels of direct human forcing and different future projections of climate (SSP1-2.6, SSP3-7.0 and SSP5-8.5). **Group III** simulations account for future changes in the direct human forcing and are intended to be started once the corresponding direct human forcing input data are available.
