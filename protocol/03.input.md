...
The base directory for input data at DKRZ is: `/work/bb0820/ISIMIP/ISIMIP3a/InputData/`
{% else %}
The base directory for input data at DKRZ is: `/work/bb0820/ISIMIP/ISIMIP3b/InputData/`
{% endif %}
